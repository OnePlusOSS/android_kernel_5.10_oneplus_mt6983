 ...
 * VENDOR_EDIT
 * File: - oplus_wakelock_profiler/oplus_wakelock_profiler.c
 * Description: Utils for monitoring wakeup sources ...
 * Version: 1.1
 * Date:
 * Author:
 *
 ...
 *   Sunfaliang     2020-04-30        2.0             rebuild
 *-------------------------------------------------------------------
 */


#ifndef __OPPO_WAKELOCK_PROFILER_H__
#define __OPPO_WAKELOCK_PROFILER_H__
...
#define IRQ_NAME_SENSOR_SCP "SCP"
#define IRQ_NAME_SENSOR_MBOX "MBOX"
#define IRQ_NAME_WLAN_IPCC_DATA "wlan"
#define IRQ_NAME_ADSP "ADSP"
#define IRQ_NAME_POWERKEY "pwrkey"
#define IRQ_NAME_MODEM_CCIF "CCIF"
#define IRQ_NAME_MODEM_DPMAIF "DPMAIF_AP"
...
#ifdef CONFIG_OPPO_WAKELOCK_PROFILER
