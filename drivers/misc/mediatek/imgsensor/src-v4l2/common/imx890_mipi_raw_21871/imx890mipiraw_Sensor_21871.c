...
#include "imx890mipiraw_Sensor_21871.h"
#include "imx890_eeprom_21871.h"
#include "imx890_ana_gain_table_21871.h"
#include "imx890_Sensor_setting_21871.h"
...
#define IMX890_EEPROM_READ_ID_21871  0xA1
#define IMX890_EEPROM_WRITE_ID_21871 0xA0
#define IMX890_SENSOR_ID 0x0890
#define _I2C_BUF_SIZE 256
#define P24C256C_EEPROM_FLAG (0x02)
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX890_EEPROM_READ_ID_21871 >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}
                   ...
                   BYTE *data, int size)
{
    ...
    if (adaptor_i2c_rd_p8(ctx->i2c_client, IMX890_EEPROM_READ_ID_21871 >> 1,
                addr, data, size) < 0) {
        return false;
    }
    return true;
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_21871 >> 1,
            addr, para, WRITE_DATA_MAX_LENGTH);

    return ret;
}

static kal_int32 write_gt24p125g_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    kal_int32 ret = ERROR_NONE;
    if ( enable ) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_21871 >> 1, 0xE000, 0xA1);
    } else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_21871 >> 1, 0xE000, 0xA0);
    }
    return ret;
}

static kal_int32 write_p24c256c_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    kal_int32 ret = ERROR_NONE;
    kal_uint16 reg = 0xa000;
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_21871 >> 1, reg, 0x0E);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_21871 >> 1, reg, 0x00);
    }
...
static kal_int32 write_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    if ( flag == P24C256C_EEPROM_FLAG ) {
		//eeprom is P24C256C, ver1 module
        ret = write_p24c256c_eeprom_protect(ctx, enable);
    } else {
        //eeprom is GT24P128G-2CSLI-TR, ver2 module
        ret = write_gt24p125g_eeprom_protect(ctx, enable);
    }
    return ret;
}
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if (flag == P24C256C_EEPROM_FLAG) {
           //eeprom is P24C256C, ver1 module
            data_base = (pStereodata->baseAddr & 0xFFFF);
        } else {
            //eeprom is GT24P128G-2CSLI-TR, ver2 module
            data_base = (pStereodata->baseAddr >> 16 & 0xFFFF);
        }
        data_length = pStereodata->dataLength;
        pData = pStereodata->uData;
        if ((pStereodata->uSensorId == IMX890_SENSOR_ID_21871) && (data_length == CALI_DATA_MASTER_LENGTH)
            && ((data_base == IMX890_STEREO_START_ADDR_VER2) || (data_base == IMX890_STEREO_START_ADDR))) {
        ...
        } else if ((pStereodata->uSensorId == IMX890_SENSOR_ID_21871) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && ((data_base == IMX890_AESYNC_START_ADDR)||(data_base == IMX890_AESYNC_START_ADDR_VER2))) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, data_base),
                    read_cmos_eeprom_8(ctx, data_base+1),
                    read_cmos_eeprom_8(ctx, data_base+2),
                    read_cmos_eeprom_8(ctx, data_base+3),
                    read_cmos_eeprom_8(ctx, data_base+4),
                    read_cmos_eeprom_8(ctx, data_base+5),
                    read_cmos_eeprom_8(ctx, data_base+6),
                    read_cmos_eeprom_8(ctx, data_base+7));
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX890_SENSOR_ID_21871,
    ...
    .custom2 = { /* Reg_W-4-1_4096x3072_24FPS 856MHz*/
        .pclk = 1502400000,
        .linelength = 15616,
        .framelength = 4008,
        .startx = 0,
    ...
    .custom7 = { /* Reg_Q-2-1_4096x2304_30FPS, normal_video for preISP*/
        .pclk = 2246400000,
        .linelength = 15616,
        .framelength = 4794,
        .startx = 0,
    ...
    .custom8 = { /* Reg_R-2 4096x2304_30FPS, 2DOL Video for preISP */
        .pclk = 2246400000,
        .linelength = 15616,
        .framelength = 4792,
        .startx = 0,
...
static struct SENSOR_VC_INFO2_STRUCT SENSOR_VC_INFO2[] = {
    ...
    },
    {
        ...
        {
            {VC_STAGGER_NE, 0x00, 0x2b, 0x1000, 0x900},
            {VC_PDAF_STATS_NE_PIX_1, 0x02, 0x2b, 4096, 576},
        },
        1
    },
    {
...
#define QSC_EEPROM_VER2_ADDR 0x1150
...
#define QSC_IS_VALID_VER2_ADDR 0x1D51
...
static void read_module_data(struct subdrv_ctx *ctx)
{
    kal_uint16 idx = 0;
    u8 flag = 0;
    read_imx890_eeprom_info_21871(ctx, EEPROM_META_MODULE_ID,
                &(imx890_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx890_common_data[1] << 8) |
                   imx890_common_data[0];
    read_imx890_eeprom_info_21871(ctx, EEPROM_META_SENSOR_ID,
                &(imx890_common_data[2]), 2);
    read_imx890_eeprom_info_21871(ctx, EEPROM_META_LENS_ID,
                &(imx890_common_data[4]), 2);
    read_imx890_eeprom_info_21871(ctx, EEPROM_META_VCM_ID,
                &(imx890_common_data[6]), 2);
    read_imx890_eeprom_info_21871(ctx, EEPROM_META_MODULE_SN,
                &(imx890_common_data[8]), 17);
    read_imx890_eeprom_info_21871(ctx, EEPROM_META_AF_CODE,
                &(imx890_common_data[25]), 6);
    ...
    if (flag == P24C256C_EEPROM_FLAG) {
        ...
        //The AF position code is 8bit for ver1 module
        ...
        //eeprom is GT24P128G-2CSLI-TR, ver2 module
        qsc_is_valid = read_cmos_eeprom_8(ctx, QSC_IS_VALID_VER2_ADDR);
    }
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    if (sensor_id == IMX890_SENSOR_ID) {
        ...
        imx890_table_write_cmos_sensor_8(ctx, imx890_init_otp_setting_21871,
            sizeof(imx890_init_otp_setting_21871)/sizeof(kal_uint16));
        LOG_INF("write 890 OTP -\n");
    }
    imx890_table_write_cmos_sensor_8(ctx, imx890_init_setting_21871,
        sizeof(imx890_init_setting_21871)/sizeof(kal_uint16));
...
unsigned short imx890_seamless_preview_Optimize1_21871[] = {
    0x38B0,0x00,
    0x38B1,0x00,
    0x38B2,0x00,
    0x38B3,0x00,
...
unsigned short imx890_seamless_custom5_Optimize1_21871[] = {
    0x38B0,0x00,
    0x38B1,0x86,
    0x38B2,0x00,
    0x38B3,0x86,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    switch (scenario_id) {
        ...
        FMC_GPH_START;
        imx890_table_write_cmos_sensor_8(ctx, imx766_seamless_custom4,
            sizeof(imx766_seamless_custom4) / sizeof(kal_uint16));
    ...
    case SENSOR_SCENARIO_ID_NORMAL_VIDEO:
    {
        ...
        FMC_GPH_START;
        imx890_table_write_cmos_sensor_8(ctx, imx766_seamless_normal_video,
    ...
    case SENSOR_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_custom5_21871,
                sizeof(imx890_seamless_custom5_21871) / sizeof(kal_uint16));
        ...
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_custom5_Optimize1_21871, sizeof(imx890_seamless_custom5_Optimize1_21871)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
    case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_normal_preview_21871,
                 sizeof(imx890_seamless_normal_preview_21871) / sizeof(kal_uint16));
        ...
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_preview_Optimize1_21871, sizeof(imx890_seamless_preview_Optimize1_21871)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
                ...
                UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx890_ana_gain_table_21871);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx890_ana_gain_table_21871,
            sizeof(imx890_ana_gain_table_21871));
        }
        break;
...
const struct subdrv_entry imx890_mipi_raw_21871_entry = {
    .name = "imx890_mipi_raw_21871",
    .id = IMX890_SENSOR_ID_21871,
    .pw_seq = pw_seq,
