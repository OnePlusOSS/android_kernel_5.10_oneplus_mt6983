...
#include "imx766mipiraw_Sensor_21121.h"
#include "imx766_eeprom_21121.h"
#include "imx766_ana_gain_table_21121.h"
#include "imx766_Sensor_setting_21121.h"
...
#define IMX766_EEPROM_READ_ID_21121  0xA2
#define IMX766_EEPROM_WRITE_ID_21121 0xA2
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX766_EEPROM_READ_ID_21121 >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}
                   ...
                   BYTE *data, int size)
{
    ...
    if (adaptor_i2c_rd_p8(ctx->i2c_client, IMX766_EEPROM_READ_ID_21121 >> 1,
                addr, data, size) < 0) {
        return false;
    }
    return true;
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_21121 >> 1,
...
static kal_int32 write_1st_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_21121 >> 1, reg, 0x0);

    reg = 0x06ca;
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_21121 >> 1, reg, 0x2);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_21121 >> 1, reg, 0x0);
    }

    adaptor_i2c_rd_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_21121 >> 1, reg, &flag);
...
static kal_int32 write_2nd_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_21121 >> 1, reg, 0x0E);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_21121 >> 1, reg, 0x00);
    }
...
static kal_int32 write_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    u8 flag = 0;
    int ret = 0;
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX766_EEPROM_READ_ID_21121 >> 1, 0x000D, &flag);
    if ( flag == 0x01 ) {
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == IMX766_SENSOR_ID_21121) && (data_length == CALI_DATA_MASTER_LENGTH)
        ...
        } else if ((pStereodata->uSensorId == IMX766_SENSOR_ID_21121) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX766_AESYNC_START_ADDR_21121)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121+1),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121+2),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121+3),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121+4),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121+5),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121+6),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_21121+7));
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX766_SENSOR_ID_21121,
...
{
    kal_uint16 idx = 0;
    read_imx766_eeprom_info_21121(ctx, EEPROM_META_MODULE_ID,
                &(imx766_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx766_common_data[1] << 8) |
                   imx766_common_data[0];
    read_imx766_eeprom_info_21121(ctx, EEPROM_META_SENSOR_ID,
                &(imx766_common_data[2]), 2);
    read_imx766_eeprom_info_21121(ctx, EEPROM_META_LENS_ID,
                &(imx766_common_data[4]), 2);
    read_imx766_eeprom_info_21121(ctx, EEPROM_META_VCM_ID,
                &(imx766_common_data[6]), 2);
    read_imx766_eeprom_info_21121(ctx, EEPROM_META_MODULE_SN,
                &(imx766_common_data[8]), 17);
    read_imx766_eeprom_info_21121(ctx, EEPROM_META_AF_CODE,
    ...
    for (idx = 0; idx < 32; idx = idx + 4)
        LOG_INF("In %s:cam data: %02x %02x %02x %02x\n", __func__,
               ...
               imx766_common_data[idx + 2],
               imx766_common_data[idx + 3]);
...
{
    LOG_INF("E\n");
    imx766_table_write_cmos_sensor_8(ctx, imx766_init_setting_21121,
        sizeof(imx766_init_setting_21121)/sizeof(kal_uint16));
...
unsigned short imx766_seamless_preview_Optimize1[] = {
    0x38B0,0x00,
    0x38B1,0x00,
    0x38B2,0x00,
    0x38B3,0x00,
...
unsigned short imx766_seamless_custom5_Optimize1[] = {
    0x38B0,0x00,
    0x38B1,0x86,
    0x38B2,0x00,
    0x38B3,0x86,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case SENSOR_SCENARIO_ID_CUSTOM7:
    {
        unsigned short imx766_seamless_custom7[] = {
            0x0340, 0x12,
            0x0341, 0xBA,
            0x0202, 0x12,
            0x0203, 0x8A,
        ...
        FMC_GPH_START;
        imx766_table_write_cmos_sensor_8(ctx, imx766_seamless_custom7,
                sizeof(imx766_seamless_custom7) / sizeof(kal_uint16));
    ...
    case SENSOR_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx766_table_write_cmos_sensor_8(ctx, imx766_seamless_custom5_21121,
                sizeof(imx766_seamless_custom5_21121) / sizeof(kal_uint16));
        ...
        imx766_table_write_cmos_sensor_8(ctx, imx766_seamless_custom5_Optimize1, sizeof(imx766_seamless_custom5_Optimize1)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
    case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx766_table_write_cmos_sensor_8(ctx, imx766_seamless_normal_preview_21121,
                 sizeof(imx766_seamless_normal_preview_21121) / sizeof(kal_uint16));
        ...
        imx766_table_write_cmos_sensor_8(ctx, imx766_seamless_preview_Optimize1, sizeof(imx766_seamless_preview_Optimize1)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
                ...
                UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx766_ana_gain_table_21121);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx766_ana_gain_table_21121,
            sizeof(imx766_ana_gain_table_21121));
        }
        break;
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6861000;
        break;
    ...
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        ...
        case EEPROM_STEREODATA_MT_MAIN:
            read_imx766_eeprom_info_21121(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
    ...
    case SENSOR_FEATURE_GET_BINNING_TYPE:
        ...
        LOG_INF("IMX766 SENSOR_FEATURE_GET_BINNING_TYPE AE_binning_type:%d,\n",
...
const struct subdrv_entry imx766_mipi_raw_21121_entry = {
    .name = "imx766_mipi_raw_21121",
    .id = IMX766_SENSOR_ID_21121,
    .pw_seq = pw_seq,
