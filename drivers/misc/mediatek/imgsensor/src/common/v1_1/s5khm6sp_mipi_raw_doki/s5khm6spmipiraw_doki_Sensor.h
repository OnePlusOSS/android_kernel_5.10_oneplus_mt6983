 ...
 * Filename:
 * ---------
 *	 s5khm6spmipiraw_changzheng_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _S5KHM6SMIPI_SENSOR_H
#define _S5KHM6SMIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct slim_video;	//slim video
