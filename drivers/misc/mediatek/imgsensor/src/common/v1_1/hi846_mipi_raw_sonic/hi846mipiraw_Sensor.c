...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846_SENSOR_ID_SONIC,
	...
	.hs_video = {
		.pclk = 288000000,
		.linelength = 3800, 			//record different mode's linelength
		.framelength = 842, 		//record different mode's framelength
		.startx = 0,
		.starty = 0,
...
{
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // preview
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // capture
 { 3280, 2464,   0, 312,   3280, 1840,   3280, 1840,   8, 2, 3264, 1836,   0, 0, 3264, 1836}, // video
 { 3280, 2464,   0, 508,   3280, 1448,   1640, 724,   180, 2, 1280, 720,   0, 0, 1280, 720},//hight speed video
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // slim video
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448},
 { 3280, 2464,   0,   4,   3280, 2456,   1640, 1228,   4, 2, 1632, 1224,   0, 0, 1632, 1224},
 { 3280, 2464,   0,   4,   3280, 2456,   1640, 1228,   4, 2, 1632, 1224,   0, 0, 1632, 1224},
 { 3280, 2464,   0, 690,   3280, 1084,   3280, 1084, 680, 2, 1920, 1080,   0, 0, 1920, 1080}, //1080p 60fps
};
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi846[] = {
    0x0066, 0x0101,
    0x2000, 0x98E8,
    0x2002, 0x00FF,
    0x2004, 0x0006,
...
static void sensor_init(void)
{
	...
	hi846_table_write_cmos_sensor(
		addr_data_pair_init_hi846,
		sizeof(addr_data_pair_init_hi846) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x095A, 0x9243);
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_preview_hi846,
		sizeof(addr_data_pair_preview_hi846) /
		sizeof(kal_uint16));
#else
	LOG_INF("E preview\n");
	////////////////////////////////////////////////////////////
	//	Sensor                   : 	Hi-846
	//	Mode                     : 	"3264x2448_30fps"
	//	Image Size               : 	3264 x 2448
	//	Max Framerate(fps)       :  30.0
	//	MIPI Speed(Mbps) x Lane  : 	680	x4
	//	MCLK(Mhz)                : 	24
	//	Pixel Order              :  GB
	////////////////////////////////////////////////////////////
	write_cmos_sensor(0x002E, 0x1111);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi846_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi846,
		sizeof(addr_data_pair_capture_30fps_hi846) /
		sizeof(kal_uint16));
	} else {
	hi846_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi846,
		sizeof(addr_data_pair_capture_fps_hi846) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
static void normal_video_setting(void)
{
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_video_hi846,
		sizeof(addr_data_pair_video_hi846) /
		sizeof(kal_uint16));
#else
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	...
	write_cmos_sensor(0x005C, 0x2101);
	write_cmos_sensor(0x0006, 0x09D0);
	write_cmos_sensor(0x0008, 0x0ED8);
	write_cmos_sensor(0x000C, 0x0022);
	write_cmos_sensor(0x0A22, 0x0000);
	write_cmos_sensor(0x0A24, 0x0000);
	...
	write_cmos_sensor(0x0074, 0x09CA);
	write_cmos_sensor(0x021C, 0x0001);
	write_cmos_sensor(0x0A04, 0x014A);
...
static void hs_video_setting(void)
{
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi846,
		sizeof(addr_data_pair_hs_video_hi846) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x2008, 0x38FD);
	write_cmos_sensor(0x326E, 0x0000);
	write_cmos_sensor(0x0710, 0x02E8);
	write_cmos_sensor(0x0900, 0x0300);
	write_cmos_sensor(0x0902, 0xC319);
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi846,
		sizeof(addr_data_pair_slim_video_hi846) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x002E, 0x1111);
	write_cmos_sensor(0x0032, 0x1111);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_hi846[] = {
    0x002E, 0x1111,
    0x0032, 0x1111,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
static void custom1_setting(void)
{
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom1_hi846,
		sizeof(addr_data_pair_custom1_hi846) /
		sizeof(kal_uint16));
#else
	LOG_INF("E custom1\n");
	write_cmos_sensor(0x002E, 0x1111);
	...
	write_cmos_sensor(0x002C, 0x09CF);
	write_cmos_sensor(0x005C, 0x2101);
	write_cmos_sensor(0x0006, 0x0C55);
	write_cmos_sensor(0x0008, 0x0ED8);
	write_cmos_sensor(0x000C, 0x0022);
	write_cmos_sensor(0x0A22, 0x0000);
	write_cmos_sensor(0x0A24, 0x0000);
	...
	write_cmos_sensor(0x0A12, 0x0CC0);
	write_cmos_sensor(0x0A14, 0x0990);
	write_cmos_sensor(0x0074, 0x0C4F);
	write_cmos_sensor(0x021C, 0x0001);
	write_cmos_sensor(0x0A04, 0x014A);
	write_cmos_sensor(0x0418, 0x0000);
	write_cmos_sensor(0x0128, 0x0025);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_hi846[] = {
    0x002E, 0x3311,
    0x0032, 0x3311,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom2_hi846,
		sizeof(addr_data_pair_custom2_hi846) /
		sizeof(kal_uint16));
#else
	LOG_INF("E custom2\n");
	write_cmos_sensor(0x002E, 0x3311);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_hi846[] = {
    0x002E, 0x3311,
    0x0032, 0x3311,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom3_hi846,
		sizeof(addr_data_pair_custom3_hi846) /
		sizeof(kal_uint16));
#else
	LOG_INF("E custom3\n");
	//Sensor Information////////////////////////////
...
kal_uint16 addr_data_pair_custom4_hi846[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x02EC,
	0x002C, 0x0723,
...
{
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom4_hi846,
		sizeof(addr_data_pair_custom4_hi846) /
		sizeof(kal_uint16));
}
...
UINT32 HI846_MIPI_RAW_SONIC_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
