...
//Just for debug
//#define MTK_LOAD_DEBUG 1
//#define DEBUG

static unsigned int do_single_lsc_imx890(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_imx890(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_imx890(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0x00E50148, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00004000, 0x0000074C, do_single_lsc_imx890},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_imx890}, //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_imx890}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT imx890_op_eeprom_21871 = {
	.name = "imx890_op_eeprom_21871",
