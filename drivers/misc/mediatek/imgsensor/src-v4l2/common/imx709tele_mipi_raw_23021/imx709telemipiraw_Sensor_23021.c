...
#include "imx709telemipiraw_Sensor_23021.h"
#include "imx709tele_ana_gain_table_23021.h"
#include "imx709tele_eeprom_23021.h"
...
//#define imx709tele_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#define imx709tele_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define imx709tele_seq_write_cmos_sensor(...)  subdrv_i2c_wr_seq_p8(__VA_ARGS__)
/***************Modify Following Strings for Debug**********************/
#define PFX "imx709tele_camera_sensor_23021"
#define LOG_1 LOG_INF("IMX709TELE,MIPI 4LANE\n")
/****************************Modify end**************************/
...
//static kal_uint16 imx709tele_table_write_cmos_sensor(ctx, kal_uint16 *para, kal_uint32 len);

#define _I2C_BUF_SIZE 256
static kal_uint16 _i2c_data[_I2C_BUF_SIZE];
static unsigned int _size_to_write;

static kal_uint16 imx709tele_LRC_setting[LRC_SIZE*2];
static kal_uint8 imx709tele_QSC_setting[QSC_SIZE];
...
static struct oplus_get_eeprom_common_data imx709tele_common_data = {0};

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX709TELE_SENSOR_ID_23021,
    .checksum_value = 0x5a6563df,

    .pre = { //reg_N-2 3264x2448 @29FPS w/ PD Izoom w/ N-3
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2528,
        .startx = 0,
        ...
        .max_framerate = 290, /* 30fps */
        .readout_length = 0,
        .read_margin = 8,
    },

    .cap = { //reg_N-2 3264x2448 @29FPS w/ PD Izoom w/ N-3
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2528,
        .startx = 0,
    ...
    .normal_video = { /* reg_C5_1, 3264x1856 @30FPS  w/PD ( On the fly to/from reg_I5_1 ) */
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2448,
        .startx = 0,
    ...
    .custom2 = {  /* reg_H3 1632x1224 @30FPS w/ PD PCLK=355.2M */
        .pclk = 355200000,
        .linelength = 5880,
        .framelength = 2008,
        .startx = 0,
    ...
    .custom3 = {/* reg_A_5 6528x4896 @15FPS RMSC ( From A_3 ) */
        .pclk = 537600000,
        .linelength = 7120,
        .framelength = 5032,
        .startx = 0,
    ...
    .custom4 = { /* reg_I5_1 3264x1856 @30FPS ( Dbin 2-DOL, 1118M ) max VB 1ST */
        .pclk = 864000000,
        .linelength = 7456,
        .framelength = 1928*2,
        .startx = 0,
    ...
    .custom5 = {/* reg_C5_1, 3264x1856 @30FPS  w/PD ( On the fly to/from reg_I5_1  unuesed mode) */
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2448,
        .startx = 0,
    ...
    .custom6 = {/* reg_I5_1 3264x1856 @30FPS ( Dbin 2-DOL, 1118M ) max VB 1ST  unused mode*/
        .pclk = 864000000,
        .linelength = 7456,
        .framelength = 1928 * 2,
        .startx = 0,
    ...
    .custom7 = {  //reg_N-4 3264x2448 @24FPS w/ PD
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 3056,
        .startx = 0,
    ...
    .custom8 = { /* reg_C5_1, 3264x1856 @30FPS  w/PD ( On the fly to/from reg_I5_1 ) */
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2448,
        .startx = 0,
    ...
    .custom9 = {  //reg_N-3 3264x2448 @29FPS Full-Crop Izoom w/ N-2  ununsed mode
        .pclk = 864000000,
        .linelength = 7120,
        .framelength = 4184,
        .startx = 0,
    ...
    .custom10 = {  /* reg_H3 1632x1224 @30FPS w/ PD PCLK=355.2M */
        .pclk = 355200000,
        .linelength = 5880,
        .framelength = 2008,
        .startx = 0,
    ...
    .custom11 = {  //reg_N-4 3264x2448 @24FPS w/ PD  unused mode
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 3056,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 464000000,
        .max_framerate = 240, /* 30fps */
        .readout_length = 0,
        .read_margin = 8,
    },

    .custom12 = { // reg_N3 3264x2448 @29FPS Full-Crop Izoom w/ N-2
        .pclk = 864000000,
        .linelength = 11784,
        .framelength = 2528,
        .startx = 0,
    ...
    .custom13 = { //reg_N-2 3264x2448 @29FPS w/ PD Izoom w/ N-3
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2528,
        .startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
    {6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* Preview  reg_N-2*/
    ...
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* reg_I5_1 3264x1856 @30FPS ( Dbin 2-DOL, 1118M ) max VB 1ST */
    ...
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* reg_C5_1, 3264x1856 @30FPS  w/PD ( On the fly to/from reg_I5_1  unuesed mode) */
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* pre isp custom9  reg_I3*/
    {6560, 4928, 0,   0, 6560, 4928, 1640, 1232,  4,   4, 1632, 1224,  0,  0, 1632, 1224}, /* cusotm10 reg_H3 1632x1224 @30FPS w/ PD PCLK=355.2M */
    {6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, //custom11 reg_N-4 3264x2448 @24FPS w/ PD
    {6560, 4928,1648,1240,3264,2448, 3264, 2448,  0,   0, 3264, 2448,  0,  0, 3264, 2448}, /* custom12  reg_N-3*/
    {6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* custom13  reg_N-2*/
};
...
{
	if (_size_to_write) {
		imx709tele_table_write_cmos_sensor(ctx, _i2c_data, _size_to_write);
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX709TELE_EEPROM_SLAVE_ADDRESS >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}
...
static void read_module_data(struct subdrv_ctx *ctx)
{
	...
	memset(&imx709tele_common_data, 0x00, sizeof(imx709tele_common_data));

	imx709tele_common_data.header[EEPROM_MODULE_ID] = 2;
	read_imx709tele_eeprom_info_23021(ctx, EEPROM_META_MODULE_ID,
				&(imx709tele_common_data.data[idx]), 2);
	imgsensor_info.module_id = (kal_uint16)(imx709tele_common_data.data[idx + 1] << 8) |
				   imx709tele_common_data.data[idx];
	idx += imx709tele_common_data.header[EEPROM_MODULE_ID];

	imx709tele_common_data.header[EEPROM_SENSOR_ID] = 2;
	read_imx709tele_eeprom_info_23021(ctx, EEPROM_META_SENSOR_ID,
				&(imx709tele_common_data.data[idx]), 2);
	idx += imx709tele_common_data.header[EEPROM_SENSOR_ID];

	imx709tele_common_data.header[EEPROM_LENS_ID] = 2;
	read_imx709tele_eeprom_info_23021(ctx, EEPROM_META_LENS_ID,
				&(imx709tele_common_data.data[idx]), 2);
	idx += imx709tele_common_data.header[EEPROM_LENS_ID];

	imx709tele_common_data.header[EEPROM_VCM_ID] = 2;
	read_imx709tele_eeprom_info_23021(ctx, EEPROM_META_VCM_ID,
				&(imx709tele_common_data.data[idx]), 2);
	idx += imx709tele_common_data.header[EEPROM_VCM_ID];

	imx709tele_common_data.header[EEPROM_MODULE_SN] = 17;
	read_imx709tele_eeprom_info_23021(ctx, EEPROM_META_MODULE_SN,
				&(imx709tele_common_data.data[idx]), 17);
	idx += imx709tele_common_data.header[EEPROM_MODULE_SN];

	imx709tele_common_data.header[EEPROM_AF_CODE_MACRO] = 2;
	imx709tele_common_data.header[EEPROM_AF_CODE_INFINITY] = 2;
	imx709tele_common_data.header[EEPROM_AF_CODE_MIDDLE] = 2;
	read_imx709tele_eeprom_info_23021(ctx, EEPROM_META_AF_CODE,
				&(imx709tele_common_data.data[idx]), 6);

    qsc_is_valid = read_cmos_eeprom_8(ctx, 0x1F18);
    lrc_is_valid = read_cmos_eeprom_8(ctx, LRC_EEPROM_FLAG_ADDR);

    for (idx = 0; idx < 40; idx = idx + 4)
        LOG_INF("In %s: cam data: %02x %02x %02x %02x\n", __func__,
               imx709tele_common_data.data[idx], imx709tele_common_data.data[idx + 1],
               imx709tele_common_data.data[idx + 2],
               imx709tele_common_data.data[idx + 3]);
}
...
static void write_shutter(struct subdrv_ctx *ctx, kal_uint32 shutter, kal_bool gph)
{
    ...
    if (shutter > (imgsensor_info.max_frame_length - imgsensor_info.margin)) {
         ...
         write_cmos_sensor_8(ctx, 0x3150, read_cmos_sensor(ctx, 0x3150) | (l_shift & 0x7));
     } else {
         write_cmos_sensor_8(ctx, 0x3150, read_cmos_sensor(ctx, 0x3150) & 0xf8);
     }
                     ...
                     kal_uint16 shutter_cnt, kal_uint16 frame_length)
{
    ...
    if (shutter_cnt == 1) {
		...
		write_cmos_sensor_8(ctx, 0x0350, 0x01); /* Disable auto extend */
...
{    kal_uint16 realtime_fps = 0;
    ...
    ctx->shutter = shutter[0];
    LOG_INF(
        "before shutter =%d, framelength =%d/%d, dummy_line=%d, auto_extend=%d, fast_mode_on=%d\n",
        shutter[0], ctx->frame_length, frame_length,
        dummy_line, read_cmos_sensor_8(ctx, 0x0350), ctx->fast_mode_on);
    ...
    if (shutter[0] > ctx->frame_length - imgsensor_info.margin)
        ctx->frame_length = shutter[0] + imgsensor_info.margin;

    if (ctx->frame_length > imgsensor_info.max_frame_length)
        ctx->frame_length = imgsensor_info.max_frame_length;
    shutter[0] = (shutter[0] < imgsensor_info.min_shutter)
            ? imgsensor_info.min_shutter : shutter[0];
    shutter[0] =
    (shutter[0] > (imgsensor_info.max_frame_length - imgsensor_info.margin))
    ...
    /* Update Shutter */
    write_cmos_sensor_8(ctx, 0x0350, 0x01); /* Disable auto extend */
    write_cmos_sensor_8(ctx, 0x0202, (shutter[0] >> 8) & 0xFF);
    write_cmos_sensor_8(ctx, 0x0203, shutter[0]  & 0xFF);
    write_cmos_sensor_8(ctx, 0x0104, 0x00);
    LOG_INF(
        "Exit! shutter[0] =%d, framelength =%d/%d, dummy_line=%d, auto_extend=%d\n",
        shutter[0], ctx->frame_length, frame_length,
...
static kal_uint16 set_gain(struct subdrv_ctx *ctx, kal_uint16 gain, kal_bool gph)
{
    ...
    if (ctx->current_scenario_id == SENSOR_SCENARIO_ID_CUSTOM3          //remosaic
        || ctx->current_scenario_id == SENSOR_SCENARIO_ID_CUSTOM12) {   //insensorzoom
...
static kal_uint16 imx709tele_rmsc_ip_setting[] = {
    //RMSC_IP_reg_210628
    0xD400, 0x00,
    0xD401, 0x00,
    0xD402, 0x00,
...
static kal_uint16 imx709tele_init_setting[] = {
    //stream off
    0x0100, 0x00,
...
/* 3264x2448 @29FPS w/ PD  (On the fly with N-3) */
static u16 imx709tele_preview_setting[] = {
    //N-2 3264x2448 @29FPS w/ PD  (On the fly with N-3)
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
/* 3264x2448 @29FPS w/ PD  (On the fly with N-3) */
static u16 imx709tele_capture_setting[] = {
    //N-2 3264x2448 @29FPS w/ PD  (On the fly with N-3)
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
...
/* reg_C5_1, 3264x1856 @30FPS  w/PD ( On the fly to/from reg_I5_1 ) */
static kal_uint16 imx709tele_normal_video_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static kal_uint16 imx709tele_hs_video_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
/*reg_G2 3264x1856@60ps*/
static kal_uint16 imx709tele_slim_video_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
/* reg_H 1632x1224 @15FPS */
static kal_uint16 imx709tele_custom1_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
/* reg_H3 1632x1224 @30FPS w/ PD PCLK=355.2M */
static kal_uint16 imx709tele_custom2_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
/* reg_A_5 6528x4896 @15FPS RMSC ( From A_3 ) */
static kal_uint16 imx709tele_custom3_setting[] = {
...
/* reg_I5_1 3264x1856 @30FPS ( Dbin 2-DOL, 1118M ) max VB 1ST */
static kal_uint16 imx709tele_custom4_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
/* reg_C5_1, 3264x1856 @30FPS  w/PD ( On the fly to/from reg_I5_1 ) */
static kal_uint16 imx709tele_custom5_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
/* reg_I5_1 3264x1856 @30FPS ( Dbin 2-DOL, 1118M ) max VB 1ST */
static u16 imx709tele_custom6_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static u16 imx709tele_custom7_setting[] = {
//4Lane
//reg_N-4
//3264x2448 @24FPS w/ PD
//H: 3264
//V: 2448
//frame_length_lines:3056
//line_length_pck:11760
//Pixel rate[Mpps]:864.00
...
/* reg_C5_1, 3264x1856 @30FPS  w/PD ( On the fly to/from reg_I5_1 ) */
static kal_uint16 imx709tele_custom8_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static u16 imx709tele_custom9_setting[] = {
//4Lane
//reg_N-3
//3264x2448 @29FPS Full-Crop Izoom w/ N-2
//H: 3264
//V: 2448
//frame_length_lines:4184
//line_length_pck:7120
//Pixel rate[Mpps]:864.00
...
static u16 imx709tele_custom10_setting[] = {
/* reg_H3 1632x1224 @30FPS w/ PD PCLK=355.2M */
//4Lane
    //MIPI output setting
    0x0112, 0x0A,
...
static kal_uint16 imx709tele_custom11_setting[] = {
//4Lane
//reg_N-4
//3264x2448 @24FPS w/ PD
//H: 3264
...
static kal_uint16 imx709tele_custom12_setting[] = {
//4Lane
//reg_N-3-LLP
//3264x2448 @29fps Full-crop (On the fly with N-2) LLP11784
//H: 3264
//V: 2448
//MIPI output setting
//Address value
...
static kal_uint16 imx709tele_custom13_setting[] = {
//4Lane
//reg_N-2
//3264x2448 @29FPS w/ PD Izoom w/ N-3
//H: 3264
//V: 2448
//frame_length_lines:2528
//line_length_pck:11760
//Pixel rate[Mpps]:864.00
...
/*
static u16 imx709tele_aonhemd_clear_setting[] = {
    0x37B7, 0x01,
};
static u16 imx709tele_aonhemd_setting[] = {
    0x0136, 0x13,
    0x0137, 0x33,
    0x3304, 0x00,
    0x33F0, 0x08,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_init_setting,
        sizeof(imx709tele_init_setting)/sizeof(kal_uint16));
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_rmsc_ip_setting,
        sizeof(imx709tele_rmsc_ip_setting)/sizeof(kal_uint16));
...
{
    LOG_INF("%s start\n", __func__);
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_preview_setting,
        sizeof(imx709tele_preview_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
} /* preview_setting */
...
{
    LOG_INF("%s start\n", __func__);
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_capture_setting,
        sizeof(imx709tele_capture_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
}
...
{
    LOG_INF("%s start\n", __func__);
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_normal_video_setting,
        sizeof(imx709tele_normal_video_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
}
...
{
    LOG_INF("%s start\n", __func__);
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_hs_video_setting,
        sizeof(imx709tele_hs_video_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
}
...
{
    LOG_INF("%s start\n", __func__);
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_slim_video_setting,
        sizeof(imx709tele_slim_video_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom1_setting,
        sizeof(imx709tele_custom1_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
}
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom2_setting,
        sizeof(imx709tele_custom2_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
}
...
static void custom3_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom3_setting,
        sizeof(imx709tele_custom3_setting)/sizeof(kal_uint16));
    LOG_INF("%s end\n", __func__);
}
...
static void custom4_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom4_setting,
        sizeof(imx709tele_custom4_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom5_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom5_setting,
        sizeof(imx709tele_custom5_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom6_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom6_setting,
        sizeof(imx709tele_custom6_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom7_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom7_setting,
        sizeof(imx709tele_custom7_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom8_setting(struct subdrv_ctx *ctx)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom8_setting,
        sizeof(imx709tele_custom8_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
{
    LOG_INF("%s start\n", __func__);
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom9_setting,
        sizeof(imx709tele_custom9_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
{
	LOG_INF("%s start\n", __func__);
	imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom10_setting,
			sizeof(imx709tele_custom10_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
{
	LOG_INF("%s start\n", __func__);
	imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom11_setting,
			sizeof(imx709tele_custom11_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
{
	LOG_INF("%s start\n", __func__);
	imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom12_setting,
			sizeof(imx709tele_custom12_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
{
	LOG_INF("%s start\n", __func__);
	imx709tele_table_write_cmos_sensor(ctx, imx709tele_custom13_setting,
			sizeof(imx709tele_custom13_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
	...
	kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
	...
	ret = adaptor_i2c_wr_p8(ctx->i2c_client, IMX709TELE_EEPROM_SLAVE_ADDRESS >> 1,
...
{
	kal_int32 ret = ERROR_NONE;
	kal_uint16 reg = IMX709TELE_EEPROM_LOCK_REGISTER_23021;
	if (enable) {
		adaptor_i2c_wr_u8(ctx->i2c_client, IMX709TELE_EEPROM_SLAVE_ADDRESS >> 1,
		reg, (IMX709TELE_EEPROM_SLAVE_ADDRESS & 0xFE) | 0x01);
	} else {
		adaptor_i2c_wr_u8(ctx->i2c_client, IMX709TELE_EEPROM_SLAVE_ADDRESS >> 1,
		reg, IMX709TELE_EEPROM_SLAVE_ADDRESS & 0xFE);
	}
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == IMX709TELE_SENSOR_ID_23021) && (data_length == CALI_DATA_SLAVE_LENGTH)
			&& (data_base == IMX709TELE_STEREO_START_ADDR_23021)) {
			...
			write_eeprom_protect(ctx, 1);
			msleep(6);
			LOG_INF("com_0:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_23021));
			LOG_INF("com_39:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_23021+39));
			LOG_INF("innal_40:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_23021+40));
			LOG_INF("innal_1556:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_23021+1544));
			LOG_INF("write_Module_data Write end\n");
		} else if ((pStereodata->uSensorId == IMX709TELE_SENSOR_ID_23021) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX709TELE_AESYNC_START_ADDR_23021)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021+1),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021+2),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021+3),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021+4),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021+5),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021+6),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_23021+7));
...
static void write_sensor_QSC(struct subdrv_ctx *ctx)
{
    ...
    if ((qsc_is_valid == 0x01) && !qsc_flag) {
        imx709tele_seq_write_cmos_sensor(ctx, 0x1000, imx709tele_QSC_setting,QSC_SIZE);
        qsc_flag = 1;
    }
    LOG_INF("%s end\n", __func__);
}
...
static void write_sensor_lrc(struct subdrv_ctx *ctx)
{
    ...
    if ((lrc_is_valid == 0x01) && !lrc_flag) {
        imx709tele_table_write_cmos_sensor(ctx, imx709tele_LRC_setting,
            sizeof(imx709tele_LRC_setting) / sizeof(kal_uint16));
        lrc_flag = 1;
    }
    LOG_INF("%s end\n", __func__);
}
...
static int get_imgsensor_id(struct subdrv_ctx *ctx, UINT32 *sensor_id)
{
     ...
     */
    LOG_INF("imx709tele Enter %s.", __func__);
            ...
            if (*sensor_id == IMX709_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(first_read){
                    ...
                    read_imx709tele_LRC_23021(ctx, imx709tele_LRC_setting);
                    read_imx709tele_QSC_23021(ctx, imx709tele_QSC_setting);
...
static kal_uint16 imx709tele_feedback_awbgain[] = {
    0x0b90, 0x00,
    0x0b91, 0x01,
    0x0b92, 0x00,
    0x0b93, 0x01,
...
static void feedback_awbgain(struct subdrv_ctx *ctx, kal_uint32 r_gain, kal_uint32 b_gain)
{
    ...
    LOG_INF("IMX709TELE feedback_awbgain r_gain: %d, b_gain: %d\n", r_gain, b_gain);
    r_gain_int = r_gain / 512;
    b_gain_int = b_gain / 512;

    imx709tele_feedback_awbgain[1] = r_gain_int;
    imx709tele_feedback_awbgain[3] = (r_gain - r_gain_int * 512) / 2;
    imx709tele_feedback_awbgain[5] = b_gain_int;
    imx709tele_feedback_awbgain[7] = (b_gain - b_gain_int * 512) / 2;
    imx709tele_table_write_cmos_sensor(ctx, imx709tele_feedback_awbgain,
        sizeof(imx709tele_feedback_awbgain)/sizeof(kal_uint16));
}
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    {
        unsigned short imx709tele_seamless_custom6[] = {
            0x0342, 0x2D,
            0x0343, 0xF0,
            0x0340, 0x09,
            0x0341, 0x90,
        ...
        FMC_GPH_START;
        imx709tele_table_write_cmos_sensor(ctx, imx709tele_seamless_custom6,
                sizeof(imx709tele_seamless_custom6) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    {
        unsigned short imx709tele_seamless_custom7[] = {
            0x0342, 0x1D,
            0x0343, 0x20,
            0x0340, 0x07,
            0x0341, 0x88,
        ...
        FMC_GPH_START;
        imx709tele_table_write_cmos_sensor(ctx, imx709tele_seamless_custom7,
                sizeof(imx709tele_seamless_custom7) / sizeof(kal_uint16));
        if (ae_ctrl) {
	...
	{
		unsigned short imx709tele_seamless_custom8[] = {
			//Line Length PCK Setting
			0x0342, 0x2D,
			0x0343, 0xF0,
			//Frame Length Lines Setting
		...
		FMC_GPH_START;
		imx709tele_table_write_cmos_sensor(ctx, imx709tele_seamless_custom8,
				sizeof(imx709tele_seamless_custom8) / sizeof(kal_uint16));
		if (ae_ctrl) {
	...
	{
			unsigned short imx709tele_seamless_custom4[] = {
				//Line Length PCK Setting
				0x0342, 0x1D,
				0x0343, 0x20,
				//Frame Length Lines Setting
			...
			FMC_GPH_START;
			imx709tele_table_write_cmos_sensor(ctx, imx709tele_seamless_custom4,
					sizeof(imx709tele_seamless_custom4) / sizeof(kal_uint16));
			if (ae_ctrl) {
	...
	{
		unsigned short imx709tele_seamless_preview[] = {
			0x0342, 0x2D,
			0x0343, 0xF0,
			0x0346, 0x00,
			0x0347, 0x10,
		...
		FMC_GPH_START;
		imx709tele_table_write_cmos_sensor(ctx, imx709tele_seamless_preview,
				sizeof(imx709tele_seamless_preview) / sizeof(kal_uint16));
		if (ae_ctrl) {
	...
	{
		unsigned short imx709tele_seamless_custom13[] = {
			0x0342, 0x2D,
			0x0343, 0xF0,
			0x0340, 0x09,
			0x0341, 0xE0,
		...
		FMC_GPH_START;
		imx709tele_table_write_cmos_sensor(ctx, imx709tele_seamless_custom13,
				sizeof(imx709tele_seamless_custom13) / sizeof(kal_uint16));
		if (ae_ctrl) {
			LOG_INF("call SENSOR_SCENARIO_ID_NORMAL_custom13 %d %d",
					ae_ctrl[0], ae_ctrl[5]);
			set_shutter(ctx, ae_ctrl[0], KAL_FALSE);
			set_gain(ctx, ae_ctrl[5], KAL_FALSE);
		}
	...
	{
		unsigned short imx709tele_seamless_custom12[] = {
			0x0342, 0x2E,
			0x0343, 0x08,
			0x0346, 0x04,
			0x0347, 0xD8,
		...
		FMC_GPH_START;
		imx709tele_table_write_cmos_sensor(ctx, imx709tele_seamless_custom12,
				sizeof(imx709tele_seamless_custom12) / sizeof(kal_uint16));
		if (ae_ctrl) {
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
    ...
    LOG_INF("scenario_id = %d, ctx->current_scenario_id(%d), framerate = %d\n", scenario_id, ctx->current_scenario_id, framerate);
    if(scenario_id != ctx->current_scenario_id) {
        return ERROR_INVALID_SCENARIO_ID;
    }
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx709tele_ana_gain_table_23021);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx709tele_ana_gain_table_23021,
            sizeof(imx709tele_ana_gain_table_23021));
        }
        break;
...
/*
    ...
    *feature_return_para_32++ = (imx709tele_common_data[1] << 24) |
        (imx709tele_common_data[0] << 16) |
        (imx709tele_common_data[3] << 8) |
        (imx709tele_common_data[2] & 0xFF);
    *feature_return_para_32 = (imx709tele_common_data[5] << 24) |
        (imx709tele_common_data[4] << 16) |
        (imx709tele_common_data[7] << 8) |
        (imx709tele_common_data[6] & 0xFF);
    *feature_para_len = 8;
    LOG_INF("imx709tele GET_MODULE_CamInfo:%d %d\n", *feature_para_len,
            *feature_data_32);
    break;

    case SENSOR_FEATURE_GET_MODULE_SN:
    *feature_return_para_32++ = (imx709tele_common_data[11] << 24) |
        (imx709tele_common_data[10] << 16) |
        (imx709tele_common_data[9] << 8) |
        (imx709tele_common_data[8] & 0xFF);
    *feature_para_len = 4;
    LOG_INF("imx709tele GET_MODULE_SN:%d %d\n", *feature_para_len,
            *feature_data_32);
    break;
*/
    ...
    *feature_para_len = 4;
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        if(*feature_para_len == sizeof(imx709tele_common_data) && feature_return_para_32 != feature_para_len) {
            memcpy(feature_return_para_32, &imx709tele_common_data,
                sizeof(imx709tele_common_data));
        }
        break;
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        ...
        {
            int ret = -1;
            ret = read_imx709tele_eeprom_info_23021(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
                (BYTE *)feature_return_para_32, *feature_para_len);
            LOG_INF("SENSOR_FEATURE_GET_EEPROM_STEREODATA  type:%d len:%d ret:%d\n",
                *feature_data_16, *feature_para_len, ret);
        }
    break;
#define EEPROM_8k 0x8000
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        ...
        read_imx709tele_eeprom_23021(ctx, 0x00, (BYTE *)feature_return_para_32, *feature_para_len);
    break;
    ...
    case SENSOR_FEATURE_GET_PDAF_INFO:
        ...
        break;
        case SENSOR_SCENARIO_ID_CUSTOM12:
		memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_full,
                sizeof(struct SET_PD_BLOCK_INFO_T));
            PDAFinfo->i4BlockNumX = 100;
            PDAFinfo->i4BlockNumY = 76;
        break;
...
static struct mtk_mbus_frame_desc_entry frame_desc_prev[] = {
	...
	},
	{
		.bus.csi2 = {
			.channel = 1,
			.data_type = 0x2b,
			.hsize = 800, //uint:Byte, width*10/8
			.vsize = 1216,
...
static struct mtk_mbus_frame_desc_entry frame_desc_cus11[] = { //reg_N-4_3264x2448 @29FPS Full-Crop Izoom w N-2
	{
		.bus.csi2 = {
			.channel = 0,
			.data_type = 0x2b,
...
//    .aonhemd_setting_table = imx709tele_aonhemd_setting,
//	.aonhemd_setting_len = ARRAY_SIZE(imx709tele_aonhemd_setting),
//	.aonhemd_clear_setting_table = imx709tele_aonhemd_clear_setting,
//	.aonhemd_clear_setting_len   = ARRAY_SIZE(imx709tele_aonhemd_clear_setting),
};
    ...
    struct mtk_csi_param *csi_param)
{
    ...
    case SENSOR_SCENARIO_ID_CUSTOM1:
        ...
        break;
    case SENSOR_SCENARIO_ID_CUSTOM2:
        csi_param->dphy_trail = 0x58;
        break;
    case SENSOR_SCENARIO_ID_CUSTOM3:
        csi_param->dphy_trail = 0x49;
        break;
    case SENSOR_SCENARIO_ID_CUSTOM4:
        csi_param->dphy_trail = 0x49;
        break;
...
static int update_sof_cnt(struct subdrv_ctx *ctx,
	unsigned int sof_cnt)
{
	//LOG_INF("update ctx->sof_cnt(%u)", sof_cnt);
	ctx->sof_cnt = sof_cnt;
	return 0;
}
...
*/
const struct subdrv_entry imx709tele_mipi_raw_23021_entry = {
    .name = "imx709tele_mipi_raw_23021",
    .id = IMX709TELE_SENSOR_ID_23021,
    .pw_seq = pw_seq,
